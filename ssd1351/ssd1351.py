...
class SSD1351:
    ...
    def __init__(self, bus=0, device=0, dc_pin="P9_15", reset_pin="P9_13", buffer_rows=128, buffer_cols=128, rows=128, cols=128):
        self.cols = cols
        self.rows = rows
    ...
    def encode_color(self, color):
        ...
        greenScaled = int(self.scale(green, 0, 0xFF, 0, 0x40))

...
while True:
    ...
    disp.fillScreen(disp.encode_color(0xFFFFFF)) # should be white
    ...
    disp.draw_text(32,32,'hey',disp.encode_color(0x00FF00)) # should be green
    # disp.dump_buffer()
    # disp.data(disp.bitmap)
    time.sleep(1)

    disp.clear_display()
    disp.fillScreen(disp.encode_color(0xFF0000))
